...
export const userDalRegistry: InjectablesRegistry = {
...
export const databaseServiceRegistry: InjectablesRegistry = {
  list(): ClassInjectable[] {
...
export const apiServiceRegistry: InjectablesRegistry = {
  list(): ClassInjectable[] {
    return [
...
export const userApiServiceRegistry: InjectablesRegistry = {
  list(): ClassInjectable[] {
    return [
      { identifier: UserVerificationService, value: UserVerificationService, type: 'PARAM' },
...
export const userDigestServiceRegistry: InjectablesRegistry = {
  list: (): ClassInjectable[] => [{ identifier: 'SOME_VALUE_TOKEN', type: 'PARAM', value: Array }],
  resolve: () => undefined,
};

export const emptyRegistry: InjectablesRegistry = {
  list: (): ClassInjectable[] => [],
  resolve: () => undefined,
};

export const userServiceRegistry: InjectablesRegistry = {
  list(): ClassInjectable[] {
    return [
